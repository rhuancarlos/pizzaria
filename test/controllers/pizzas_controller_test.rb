...
class PizzasControllerTest < ActionController::TestCase
  ...
  test "should create pizza" do
    assert_difference('Pizza.count') do
      post :create, pizza: { foto: @pizza.foto, ingredientes: @pizza.ingredientes, nome: @pizza.nome, precog: @pizza.precog, precom: @pizza.precom, precop: @pizza.precop }
    end
  ...
  test "should update pizza" do
    patch :update, id: @pizza, pizza: { foto: @pizza.foto, ingredientes: @pizza.ingredientes, nome: @pizza.nome, precog: @pizza.precog, precom: @pizza.precom, precop: @pizza.precop }
    assert_redirected_to pizza_path(assigns(:pizza))
  end
