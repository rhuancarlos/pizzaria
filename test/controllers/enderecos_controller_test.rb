...
class EnderecosControllerTest < ActionController::TestCase
  ...
  test "should create endereco" do
    assert_difference('Endereco.count') do
      post :create, endereco: { bairro: @endereco.bairro, cidade: @endereco.cidade, cliente_id: @endereco.cliente_id, logradouro: @endereco.logradouro, pontoreferencia: @endereco.pontoreferencia }
    end
  ...
  test "should update endereco" do
    patch :update, id: @endereco, endereco: { bairro: @endereco.bairro, cidade: @endereco.cidade, cliente_id: @endereco.cliente_id, logradouro: @endereco.logradouro, pontoreferencia: @endereco.pontoreferencia }
    assert_redirected_to endereco_path(assigns(:endereco))
  end
